...
if __name__ == "__main__":
    source_dirs = [
        r"D:\PROJECT\AI-Project\ChangeDetect\MambaCD\data\SECOND\train\GT_T2_COLORED",
        r"E:\xunlei\EIP-SCD512_EN\label2_rgb",
        r"D:\PROJECT\AI-Project\ChangeDetect\MambaCD\data\SECOND\test\GT_T2_COLORED"
        # 可添加更多源目录路径...
    ]
    destination_dir = r"D:\DAS_DATASET\ChangeDetection\DATASET_NanNing\DATASET\label2_rgb"
